...
(function () {
  ...
  var INSTRUMENT_MAP = {
    /* Precious metals — GLD/SLV now on HL spot (@276/@265) — maxLev 4 (strong dashboard edge) */
    'GLD':    { hlAsset: 'GLD',    sector: 'precious', maxLev: 4 },
    'SLV':    { hlAsset: 'SLV',    sector: 'precious', maxLev: 4 },
    'SILVER': { hlAsset: 'SLV',    sector: 'precious', maxLev: 4 },
    'XAG':    { hlAsset: 'SLV',    sector: 'precious', maxLev: 4 },
    'XAU':    { hlAsset: 'GLD',    sector: 'precious', maxLev: 4 },
    ...
    /* Crypto perps — maxLev 2 (less dashboard edge vs stocks/commodities) */
    'BTC':    { hlAsset: 'BTC',    sector: 'crypto',   maxLev: 2 },
    'ETH':    { hlAsset: 'ETH',    sector: 'crypto',   maxLev: 2 },
    ...
    /* HL spot equity tokens — maxLev 3 (strong dashboard edge from geopolitical/economic data) */
    'CRCL':   { hlAsset: 'CRCL',   sector: 'equity',   maxLev: 3 },
    'TSLA':   { hlAsset: 'TSLA',   sector: 'equity',   maxLev: 3 },
    'AAPL':   { hlAsset: 'AAPL',   sector: 'equity',   maxLev: 3 },
    'AMZN':   { hlAsset: 'AMZN',   sector: 'equity',   maxLev: 3 },
    'META':   { hlAsset: 'META',   sector: 'equity',   maxLev: 3 },
    'QQQ':    { hlAsset: 'QQQ',    sector: 'equity',   maxLev: 4 },
    'MSFT':   { hlAsset: 'MSFT',   sector: 'equity',   maxLev: 3 },
    'GOOGL':  { hlAsset: 'GOOGL',  sector: 'equity',   maxLev: 3 },
    'HOOD':   { hlAsset: 'HOOD',   sector: 'equity',   maxLev: 3 },
    'SPY':    { hlAsset: 'SPY',    sector: 'equity',   maxLev: 4 },
    ...
    'ASML':   { hlAsset: 'ASML',   sector: 'equity',   maxLev: 3 },
    ...
    'GDX':    { hlAsset: 'GDX',    sector: 'equity',   maxLev: 3 },
    'SMH':    { hlAsset: 'SMH',    sector: 'equity',   maxLev: 3 },
    'SOXX':   { hlAsset: 'SOXX',  sector: 'equity',   maxLev: 3 },
    'FXI':    { hlAsset: 'FXI',    sector: 'equity',   maxLev: 3 },
    'XOM':    { hlAsset: 'XOM',    sector: 'equity',   maxLev: 3 },
    ...
    /* Extended HL crypto perps — maxLev 2 (less dashboard edge) */
    ...
    'ALGO':   { hlAsset: 'ALGO',  sector: 'crypto',   maxLev: 2 },
    'XLM':    { hlAsset: 'XLM',   sector: 'crypto',   maxLev: 2 },
    'FIL':    { hlAsset: 'FIL',   sector: 'crypto',   maxLev: 2 },
    'TRX':    { hlAsset: 'TRX',   sector: 'crypto',   maxLev: 2 },
    'PENDLE': { hlAsset: 'PENDLE',sector: 'crypto',   maxLev: 2 },
    'ZRO':    { hlAsset: 'ZRO',   sector: 'crypto',   maxLev: 2 },
    'BLUR':   { hlAsset: 'BLUR',  sector: 'crypto',   maxLev: 2 },
    'ENS':    { hlAsset: 'ENS',   sector: 'crypto',   maxLev: 2 },
    'LDO':    { hlAsset: 'LDO',   sector: 'crypto',   maxLev: 2 },
    'SAND':   { hlAsset: 'SAND',  sector: 'crypto',   maxLev: 2 },
    'FLOKI':  { hlAsset: 'FLOKI', sector: 'crypto',   maxLev: 2 },
    'SHIB':   { hlAsset: 'SHIB',  sector: 'crypto',   maxLev: 2 },
    'WLD':    { hlAsset: 'WLD',   sector: 'crypto',   maxLev: 2 },
    'TRUMP':  { hlAsset: 'TRUMP', sector: 'crypto',   maxLev: 2 },
    'ENA':    { hlAsset: 'ENA',   sector: 'crypto',   maxLev: 2 },
    'EIGEN':  { hlAsset: 'EIGEN', sector: 'crypto',   maxLev: 2 },
    'PYTH':   { hlAsset: 'PYTH',  sector: 'crypto',   maxLev: 2 },
    'CRV':    { hlAsset: 'CRV',   sector: 'crypto',   maxLev: 2 },
    'SNX':    { hlAsset: 'SNX',   sector: 'crypto',   maxLev: 2 },
    'GMX':    { hlAsset: 'GMX',   sector: 'crypto',   maxLev: 2 },
