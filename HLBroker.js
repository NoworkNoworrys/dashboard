...
(function () {
  ...
  var HL_ASSETS = {
    ...
    /* ── Equity xyz perps ────────────────────────────────────────────── */
    'AAPL':      { name: 'Apple (xyz perp)',         hlCoin: 'xyz:AAPL'  },
    'TSLA':      { name: 'Tesla (xyz perp)',         hlCoin: 'xyz:TSLA'  },
    'NVDA':      { name: 'Nvidia (xyz perp)',        hlCoin: 'xyz:NVDA'  },
    'META':      { name: 'Meta (xyz perp)',          hlCoin: 'xyz:META'  },
    'MSFT':      { name: 'Microsoft (xyz perp)',     hlCoin: 'xyz:MSFT'  },
    'AMZN':      { name: 'Amazon (xyz perp)',        hlCoin: 'xyz:AMZN'  },
    'GOOGL':     { name: 'Alphabet (xyz perp)',      hlCoin: 'xyz:GOOGL' },
    'MSTR':      { name: 'MicroStrategy (xyz perp)', hlCoin: 'xyz:MSTR'  },
    'ORCL':      { name: 'Oracle (xyz perp)',        hlCoin: 'xyz:ORCL'  },
    'MU':        { name: 'Micron (xyz perp)',        hlCoin: 'xyz:MU'    },
    'HOOD':      { name: 'Robinhood (xyz perp)',     hlCoin: 'xyz:HOOD'  },
    'CRCL':      { name: 'Circle (xyz perp)',        hlCoin: 'xyz:CRCL'  },
    'CRWV':      { name: 'CoreWeave (xyz perp)',     hlCoin: 'xyz:CRWV'  },
    'COIN':      { name: 'Coinbase (xyz perp)',      hlCoin: 'xyz:COIN'  },
    'NFLX':      { name: 'Netflix (xyz perp)',       hlCoin: 'xyz:NFLX'  },
    'AMD':       { name: 'AMD (xyz perp)',           hlCoin: 'xyz:AMD'   },
    'INTC':      { name: 'Intel (xyz perp)',         hlCoin: 'xyz:INTC'  },
    'PLTR':      { name: 'Palantir (xyz perp)',      hlCoin: 'xyz:PLTR'  },
